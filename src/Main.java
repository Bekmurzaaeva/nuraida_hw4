...
public class Main {
    ...
    public static int medicHealAmount = 100;
    ...
    public static void medicHeal() {
        for (int i = 0; i < heroesHealth.length; i++) {
            if (heroesHealth[i] > 0 && heroesHealth[i] < 100 && i != 3 && medicHealth > 0) { // Проверяем здоровье и исключаем Medic из лечения
                heroesHealth[i] += medicHealAmount;
                medicHealth -= medicHealAmount;
